...
public class LoadMoreListView extends ListView implements AbsListView.OnScrollListener{
    ...
    public void setAdapter(ListAdapter adapter){
        mFooterView =(RelativeLayout)mInflater.inflate(R.layout.load_more_view,
                this,false);
        mLoadMoreStatusView= mFooterView.findViewById(R.id.load_more_proggres_bar);
    ...
    */
    ...
    /*
    * Register a callback to be invoked when this list reaches the end
    * (last item be visible)
    *
